...
export default {
  ...
  questions: [
    ...
    },
    {
      ...
      "explanation": "הגרדיאנט של Cross-Entropy עם Sigmoid הוא (ŷ-y)x; הצבת y=0/1 באופציה 1 מניבה בדיוק תוצאה זו בעוד אופציה 0 היא הגרדיאנט של ה-Likelihood (סימן הפוך).",
      correct: 1
    }
  ]
};
